...
public class Main {
	public static void main(String[] args) {
		...
		Simulation sim = new Simulation(timeMatrix, simDuration, initialPopulation, maxPopulation, deathParam, reproductionParam, mutationParam);
		SimulationPrintingObserver observer = new SimulationPrintingObserver();
		sim.subscribeToObservations(observer);
		sim.run();
	}
}
